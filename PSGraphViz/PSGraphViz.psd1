...
FunctionsToExport = @('Get-Edge','Get-Graph','Node','Get-Rank','Get-SubGraph','Install-GraphViz','Invoke-GraphViz','New-QuickGraph')
...
AliasesToExport = @('Get-Node','Graph','Edge','SubGraph','Rank')
