...
FunctionsToExport = @('Get-Edge','Get-Graph','Get-Node','Get-Rank','Get-SubGraph','Install-GraphViz','Invoke-GraphViz','New-QuickGraph')
...
AliasesToExport = @('Node','Graph','Edge','SubGraph','Rank')
